...
export const useFilter = ({search, setExtraParams, resetFilters}) => {
    ...
    const onSearchFilterHandler = (data) => {
      ...
      let last_access_datetime_lower_bound = '';
      let last_access_datetime_upper_bound = '';
      ...
      if(data.selectedDate){
        ...
        last_access_datetime_lower_bound=dateInit.toISOString();
      }
      ...
      if(data.selectedDateEnd){
        ...
        last_access_datetime_upper_bound=dateEnd.toISOString();
      }
      ...
      setExtraParams({ 
        last_access_datetime_lower_bound,
        last_access_datetime_upper_bound,
