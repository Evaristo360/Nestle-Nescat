...
import { useStyles } from './TotemListStyles';
...
import { TotemEdit } from '../TotemEdit';
...
import { messages } from './TotemListMessages';
import { useIntlMessages } from 'hooks/useIntlMessages';
import { editTotem } from 'providers/api';
import { useTotemList } from './useTotemList';
...
export const TotemList = () => {
  ...
  const redirectStatus = () => history.push('/totem/status');
  ...
  const {
    ...
    valuesStructure, 
    setvaluesStructure
  } = useTotemList({ search, setExtraParams, resetFilters });
  ...
  return (
    <div>
      ...
      <NestcaPageHeader
        ...
        Icon={currentTheme.themeDark ? Pages.TotemPageIconDark : Pages.TotemPageIcon}
        count={totalFound}
        showFilterButton
