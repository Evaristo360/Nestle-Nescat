...
import { MenuItem, FormControl, InputLabel, Select, ListItemIcon, ListItemText, Checkbox} from '@material-ui/core';
              ...
              <div className={classes.priority}>
                ...
                >
                  ...
                  <Select
                    ...
                    name={`client_id_${index}`}
                  >
                    {list.listsOfClients.filter(function(e) { return e.id === list.listClients[index].client_id; }).length > 0 ? 
                      ...
                      }) : <MenuItem value={list.listClients[index].client_id}>{list.listClients[index].client_name}</MenuItem>}
                  </Select>
                </FormControl>
              </div> : null
            }
                    ...
                    >
                      <ListItemIcon className={classes.checkBoxSelect}>
                        <Checkbox
                          ...
                          indeterminate={
                            list.listClients[index].branch_names.length > 0 && list.listClients[index].branch_names.length < client.branches.length
                          }
                        />
                      </ListItemIcon>
                      <ListItemText
